<template>
  <div class="chart-panel">
    <div class="chart-header">
      <div>
        <div class="chart-title">电影区域占比</div>
        <div class="chart-subtitle">观察区域来源分布，辅助内容采买和宣传侧重点。</div>
      </div>
    </div>
...
function getData() {
  http.get('/statisticalReportForms/movieRegionProportionOfChar').then(res => {
