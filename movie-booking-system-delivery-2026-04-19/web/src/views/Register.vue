    ...
    <el-card class="box-card">
      <el-space direction="vertical" style="width: 100%" size="large">
        ...
        <el-form :model="formData" label-width="80px" :rules="rules" ref="formRef" style="width: 100%" inline>
          ...
          <el-form-item v-if="formData.type==='CINEMA'" label="标签" prop="label"
                        :rules="[{required:true,message:'不能为空',trigger:[ 'blur','change']}]">

            <el-input type="textarea" :rows="2" v-model="formData.label"></el-input>
          </el-form-item>
          <el-form-item label="地址" prop="address" v-if="formData.type==='CINEMA'">
